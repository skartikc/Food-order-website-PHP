    ...
    <div class="form-s-u">
        <form action='support.php' class="bootstrap-iso" method="POST">
            <div class="mt mb">   
                ...
                <input type="text" class="form-control" placeholder="<?php echo $row['owner']?>" name="h-phnum" readonly>
                <span>(Contact Support to Change the Owner Name)</span>
            </div>
            <div class="mt mb">   
                <label class="form-label">Restaurant Name :</label>
                <input type="text" class="form-control" placeholder="<?php echo $row['rname']?>" name="h-name" readonly>
                <span>(Go to the Profile Page to Change your Restaurant Name)</span>
            </div>
            <div class="mb mt">
